...
typedef NS_ENUM(NSInteger,SKErrorCode) {
    ...
    SKErrorOverlayInvalidConfiguration API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos, watchos, macCatalyst) __TVOS_PROHIBITED,
    SKErrorOverlayTimeout API_AVAILABLE(ios(14.0)) API_UNAVAILABLE(macos, watchos, macCatalyst) __TVOS_PROHIBITED,
