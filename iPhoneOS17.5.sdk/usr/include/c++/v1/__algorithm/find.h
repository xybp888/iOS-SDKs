...
#ifndef _LIBCPP_HAS_NO_WIDE_CHARACTERS
// TODO: Enable this unconditionally once Clang allows casting from a pointer to an ARC pointer to a
//       normal pointer. See rdar://114039220 for details.
#  ifndef _LIBCPP_HAS_OBJC_ARC

// TODO: Enable this unconditionally once we can assume that everyone using libc++ is linking against
//       a suitable C library. Otherwise we get undefined references to wmemchr.
#    if 0
template <class _Tp,
          class _Up,
          class _Proj,
