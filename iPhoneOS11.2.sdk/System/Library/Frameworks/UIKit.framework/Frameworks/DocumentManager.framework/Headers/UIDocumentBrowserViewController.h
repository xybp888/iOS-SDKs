...
} API_AVAILABLE(ios(11.0)) __TVOS_UNAVAILABLE NS_SWIFT_NAME(UIDocumentBrowserViewController.ImportMode);
...
} API_AVAILABLE(ios(11.0)) __TVOS_UNAVAILABLE NS_SWIFT_NAME(UIDocumentBrowserViewController.BrowserUserInterfaceStyle);
