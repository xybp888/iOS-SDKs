...
#define MACH_VM_MAX_ADDRESS_RAW   (0x0000080000000000ULL) /* 8 TiB */
#define MACH_VM_ADDRESS_MASK      (0x000007FFFFFFFFFFULL)
#define MACH_VM_NANO_BASE_ADDRESS (0x0000007000000000ULL) /* 448 GiB */
