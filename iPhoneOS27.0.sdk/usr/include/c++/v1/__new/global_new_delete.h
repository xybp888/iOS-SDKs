...
#  if defined(__cpp_sized_deallocation) && __cpp_sized_deallocation >= 201309L || _LIBCPP_STD_VER >= 14 // TODO: Remove >= C++14 once AppleClang enables sized deallocation by default
