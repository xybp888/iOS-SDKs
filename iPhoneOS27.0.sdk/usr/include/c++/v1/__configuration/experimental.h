...
// FIXME -- this is a temporary state to allow setting the assertion semantic to `observe` via `compilerClientsConfig`
// overrides. We want to be able to bypass checks for using assertion semantics without enabling all experimental
// features.
#ifndef _LIBCPP_HAS_EXPERIMENTAL_HARDENING_OBSERVE_SEMANTIC
