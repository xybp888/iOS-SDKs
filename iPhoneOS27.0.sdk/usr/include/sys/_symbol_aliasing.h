...
#if defined(__ENVIRONMENT_IPHONE_OS_VERSION_MIN_REQUIRED__) && __ENVIRONMENT_IPHONE_OS_VERSION_MIN_REQUIRED__ >= 260600
#define __DARWIN_ALIAS_STARTING_IPHONE___IPHONE_26_6(x) x
#else
#define __DARWIN_ALIAS_STARTING_IPHONE___IPHONE_26_6(x)
#endif

#if defined(__ENVIRONMENT_IPHONE_OS_VERSION_MIN_REQUIRED__) && __ENVIRONMENT_IPHONE_OS_VERSION_MIN_REQUIRED__ >= 270000
#define __DARWIN_ALIAS_STARTING_IPHONE___IPHONE_27_0(x) x
#else
#define __DARWIN_ALIAS_STARTING_IPHONE___IPHONE_27_0(x)
#endif
...
#if defined(__ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__) && __ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__ >= 260600
#define __DARWIN_ALIAS_STARTING_MAC___MAC_26_6(x) x
#else
#define __DARWIN_ALIAS_STARTING_MAC___MAC_26_6(x)
#endif

#if defined(__ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__) && __ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__ >= 270000
#define __DARWIN_ALIAS_STARTING_MAC___MAC_27_0(x) x
#else
#define __DARWIN_ALIAS_STARTING_MAC___MAC_27_0(x)
#endif
