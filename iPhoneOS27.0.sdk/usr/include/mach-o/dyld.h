...
/*
 * Given a handle returned by dlopen(), this function returns the mach_header* of the
 * loaded image to which the handle refers.
 */
extern const struct mach_header* _dyld_get_dlopen_image_header(void* handle) __API_AVAILABLE(macos(13.0), ios(16.0), watchos(9.0), tvos(16.0)) DYLD_DRIVERKIT_UNAVAILABLE;
