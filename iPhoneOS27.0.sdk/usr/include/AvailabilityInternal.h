...
#include <AvailabilityVersions.h>
            ...
            #define __MAC_OS_X_VERSION_MAX_ALLOWED __MAC_27_0
                ...
                #define __IPHONE_OS_VERSION_MAX_ALLOWED __IPHONE_27_0
            #endif
            ...
            #define __IPHONE_OS_VERSION_MAX_ALLOWED __IPHONE_27_0
                ...
                #define __WATCH_OS_VERSION_MAX_ALLOWED __WATCHOS_27_0
            ...
            #define __IPHONE_OS_VERSION_MIN_REQUIRED __IPHONE_9_0
                ...
                #define __TV_OS_VERSION_MAX_ALLOWED __TVOS_27_0
                /* for compatibility with existing code.  New code should use platform specific checks */
                #define __IPHONE_OS_VERSION_MIN_REQUIRED __IPHONE_9_0
            #endif
            ...
            #define __IPHONE_OS_VERSION_MIN_REQUIRED __IPHONE_9_0
                ...
                #define __DRIVERKIT_VERSION_MAX_ALLOWED __DRIVERKIT_27_0
            #endif
        #endif /* __has_builtin(__is_target_os) */
    #endif /* defined(__has_builtin) */
                ...
                #define __VISION_OS_VERSION_MAX_ALLOWED __VISIONOS_27_0
                /* for compatibility with existing code.  New code should use platform specific checks */
...
#if defined(__has_feature) && defined(__has_attribute)
 #if __has_attribute(availability)
   #define __API_AVAILABLE_PLATFORM_anyappleos(x) anyAppleOS,introduced=x
   #define __API_DEPRECATED_PLATFORM_anyappleos(x,y) anyAppleOS,introduced=x,deprecated=y
   #define __API_UNAVAILABLE_PLATFORM_anyappleos anyAppleOS,unavailable
 #endif /* __has_attribute(availability) */
#endif /* defined(__has_feature) && defined(__has_attribute) */
