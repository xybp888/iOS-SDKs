...
*/
API_DEPRECATED("Use ForegroundTerminationMetric instead.", ios(14.0, API_TO_BE_DEPRECATED), macos(11.0, API_TO_BE_DEPRECATED)) API_UNAVAILABLE(tvos, watchos)
...
*/
API_DEPRECATED("Use BackgroundTerminationMetric instead.", ios(14.0, API_TO_BE_DEPRECATED), macos(11.0, API_TO_BE_DEPRECATED)) API_UNAVAILABLE(tvos, watchos)
