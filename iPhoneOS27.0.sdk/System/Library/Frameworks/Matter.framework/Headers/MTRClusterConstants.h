...
typedef NS_ENUM(uint32_t, MTRAttributeIDType) {
    ...
    MTRAttributeIDTypeClusterOperationalStateAttributeAppleOperationCompletedID MTR_PROVISIONALLY_AVAILABLE = 0x13490000,
    MTRAttributeIDTypeClusterOperationalStateAttributeAppleOperationStartTimeID MTR_PROVISIONALLY_AVAILABLE = 0x13490001,
    ...
    MTRAttributeIDTypeClusterAppleDeviceInformationAttributeNeedsAdditionalConfigurationID MTR_PROVISIONALLY_AVAILABLE = 0x00000002,
