...
- (void)openSettingsWithCompletionHandler:(nullable void (^)(NSError *_Nullable error))completion API_AVAILABLE(ios(13.4)) API_UNAVAILABLE( macCatalyst, macos, watchos, tvos);
