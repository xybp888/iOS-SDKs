...
CX_EXTERN NSErrorDomain const CXErrorDomain API_AVAILABLE(ios(10.0), macCatalyst(13.0), watchos(9.0))  API_UNAVAILABLE(macos, tvos);
CX_EXTERN NSErrorDomain const CXErrorDomainIncomingCall API_AVAILABLE(ios(10.0), macCatalyst(13.0), watchos(9.0))  API_UNAVAILABLE(macos, tvos);
CX_EXTERN NSErrorDomain const CXErrorDomainRequestTransaction API_AVAILABLE(ios(10.0), macCatalyst(13.0), watchos(9.0))  API_UNAVAILABLE(macos, tvos);
CX_EXTERN NSErrorDomain const CXErrorDomainCallDirectoryManager API_AVAILABLE(ios(10.0), macCatalyst(13.0), watchos(9.0))  API_UNAVAILABLE(macos, tvos);
CX_EXTERN NSErrorDomain const CXErrorDomainNotificationServiceExtension API_AVAILABLE(ios(14.5), macCatalyst(14.5), watchos(9.0))  API_UNAVAILABLE(tvos, macos);

typedef NS_ERROR_ENUM(CXErrorDomain, CXErrorCode) {
    CXErrorCodeUnknownError = 0,
    CXErrorCodeUnentitled API_AVAILABLE(ios(13.2), macCatalyst(13.2), watchos(9.0)) API_UNAVAILABLE(macos) = 1,
    CXErrorCodeInvalidArgument API_AVAILABLE(ios(13.2), macCatalyst(13.2), watchos(9.0)) API_UNAVAILABLE(macos) = 2,
    CXErrorCodeMissingVoIPBackgroundMode API_AVAILABLE(ios(14.5), macCatalyst(14.5), watchos(9.0)) API_UNAVAILABLE(tvos, macos) = 3,
...
} API_AVAILABLE(ios(14.5), macCatalyst(14.5), watchos(9.0))  API_UNAVAILABLE(tvos, macos);
