...
/*!
 @brief Protocol to declare support for handling an INSetCarLockStatusIntent 
...
/*!
 ...
 @abstract Execute the task represented by the INSetCarLockStatusIntent that's passed in
 @discussion Called to actually execute the intent. The app must return a response for this intent.

 @param  setCarLockStatusIntent The input intent
