...
/*!
 @brief Protocol to declare support for handling an INActivateCarSignalIntent 
...
/*!
 ...
 @abstract Execute the task represented by the INActivateCarSignalIntent that's passed in
 @discussion Called to actually execute the intent. The app must return a response for this intent.

 @param  activateCarSignalIntent The input intent
