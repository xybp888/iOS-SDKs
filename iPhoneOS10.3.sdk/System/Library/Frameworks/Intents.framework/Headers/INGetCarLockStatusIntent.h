...
/*!
 @brief Protocol to declare support for handling an INGetCarLockStatusIntent 
...
/*!
 ...
 @abstract Execute the task represented by the INGetCarLockStatusIntent that's passed in
 @discussion Called to actually execute the intent. The app must return a response for this intent.

 @param  getCarLockStatusIntent The input intent
