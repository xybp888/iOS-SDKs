...
/*!
 @brief Protocol to declare support for handling an INGetCarPowerLevelStatusIntent 
...
/*!
 ...
 @abstract Execute the task represented by the INGetCarPowerLevelStatusIntent that's passed in
 @discussion Called to actually execute the intent. The app must return a response for this intent.

 @param  getCarPowerLevelStatusIntent The input intent
