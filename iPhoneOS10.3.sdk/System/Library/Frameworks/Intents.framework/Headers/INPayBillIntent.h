...
/*!
 @brief Protocol to declare support for handling an INPayBillIntent 
...
/*!
 ...
 @abstract Execute the task represented by the INPayBillIntent that's passed in
 @discussion Called to actually execute the intent. The app must return a response for this intent.

 @param  payBillIntent The input intent
